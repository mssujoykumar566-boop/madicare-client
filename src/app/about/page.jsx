...
const stats = [
  {
    ...
    value: "150+",
    desc: "Top tier specialists across departments",
  },
  {
    label: "Happy Patients",
    value: "10k+",
    desc: "Recovered and satisfied patients",
  },
  {
    label: "Success Rate",
    value: "99.2%",
    desc: "Accurate diagnoses and treatment",
  },
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-b from-slate-50 to-white border-b border-slate-100 px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
            ...
            >
              MediCare Connect is a modern telemedicine and appointment booking
              ecosystem built to streamline hospital and expert clinic
              consultations. Our mission is to make healthcare immediate,
              secure, and available to anyone, anywhere.
            </motion.p>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {stats.map((stat, i) => (
              ...
              >
                <p className="text-3xl sm:text-4xl font-black bg-gradient-to-r from-teal-500 to-cyan-600 bg-clip-text text-transparent">
                  {stat.value}
                </p>
          ...
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="text-center max-w-2xl mx-auto space-y-4">
              ...
              <p className="text-slate-500 text-sm font-medium">
                We believe healthcare is a fundamental human right. Here is how
                we enforce care standards every day.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {values.map((val, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center text-xl border ${val.bg} shadow-sm shrink-0`}
                    >
                      <Icon />
                    </div>
                    <div className="space-y-2">
                      <h3 className="text-slate-800 font-extrabold text-base tracking-wide">
                        {val.title}
                      </h3>
        ...
        <section className="py-16 md:py-20 px-4 md:px-6 max-w-7xl mx-auto space-y-12 md:space-y-16">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-slate-500 text-sm font-medium">
              Meet the medical experts and strategists directing the Medicare
              platform.
            </p>
          </div>
            ...
            {team.map((member, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-teal-600 text-xs font-bold mt-0.5">
                    {member.role}
                  </p>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6 max-w-5xl mx-auto">
          <div className="bg-gradient-to-br from-teal-500 to-cyan-600 rounded-3xl p-8 sm:p-12 text-white text-center space-y-6 shadow-xl relative overflow-hidden">
            ...
            <p className="text-teal-50 text-sm max-w-md mx-auto relative z-10 font-medium leading-relaxed">
              Book a verified consultation in minutes. Pay securely with Stripe
              and receive your medical files online.
            </p>
            <div className="pt-2 relative z-10 flex justify-center gap-4">
              <Link
                href="/find-doctors"
                className="px-6 py-3 bg-white text-teal-600 font-extrabold text-sm rounded-xl hover:bg-slate-50 shadow-md transition cursor-pointer"
              >
                Find Doctors
              </Link>
            </div>
