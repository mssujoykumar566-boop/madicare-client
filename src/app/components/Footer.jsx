          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-2 lg:pl-4">
              ...
              <ul className="space-y-3 text-slate-600 font-semibold text-sm">
                <li>
                  <Link
                    href="/"
                    className="hover:text-[#00a884] transition-colors duration-200"
                  >
                    Home
                  </Link>
                </li>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-3 text-slate-600 font-medium text-sm">
                ...
                <p className="flex items-center gap-2">
                  📧{" "}
                  <span className="text-slate-700">support@medicare.com</span>
                </p>
                <p className="flex items-center gap-2">
                  📞 <span className="text-slate-700">+880 1234-567890</span>
                </p>
                ...
                <div className="mt-4 p-4 rounded-2xl bg-gradient-to-br from-[#F4FAF8] to-white border border-emerald-100/60 shadow-sm">
                  ...
                  <h4 className="text-2xl font-black text-[#00a884] mt-0.5">
                    16000
                  </h4>
                </div>
              </div>
            ...
            <div className="lg:col-span-3 space-y-5">
              ...
              <p className="text-slate-400 text-xs font-medium leading-relaxed">
                Stay updated with premium healthcare news, feature rollouts, and
